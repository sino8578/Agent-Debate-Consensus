...
- **Поиск в интернете** — Иконка глобуса в поле ввода активирует веб-поиск для всех моделей. Через режим `:online` OpenRouter модели получают актуальные данные из интернета в реальном времени. Перечёркнутый глобус — поиск выключен, яркий — включён
